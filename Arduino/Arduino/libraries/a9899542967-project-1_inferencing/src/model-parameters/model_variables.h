...
const char* ei_classifier_inferencing_categories[] = { "C", "TIP", "centre", "needle" };
...
const ei_impulse_t impulse_565013_0 = {
    .project_id = 565013,
    .project_owner = "Abhinav Chaudhary",
    .project_name = "9899542967-project-1",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 7,

    .nn_input_frame_size = 3600,
    .raw_sample_count = 3600,
    .raw_samples_per_frame = 1,
    .dsp_input_frame_size = 3600 * 1,
    .input_width = 60,
    .input_height = 60,
    .input_frames = 1,
    .interval_ms = 1,
    ...
    .visual_ad_grid_size_x = int((60 / 8) / 2 - 1),
    .visual_ad_grid_size_y = int((60 / 8) / 2 - 1),
    
    .tflite_output_features_count = 320,
...
ei_impulse_handle_t impulse_handle_565013_0 = ei_impulse_handle_t( &impulse_565013_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_565013_0;
